...
import com.meetmatch.app.databinding.FragmentLastBinding
...
class FragmentLast : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.imageView2.setOnClickListener {
            ...
            startActivity(Intent(requireActivity(),CoreActivity::class.java))
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentLast.
         */
